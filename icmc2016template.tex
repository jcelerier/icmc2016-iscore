...
Finally, there is only a global scope in the device tree : any process can access to any variable at any point in time.
The variables should be considered elements of the object model of the local software.
